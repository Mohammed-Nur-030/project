...
export default async function handler(req, res) {
  ...
  // let convoSummary = req.body.summary
  // console.log("convoSummary",convoSummary)
  ...
  try {
    if (conversationId.length < 5) {
      ...
      console.log(typeof(UpdatedConvo.messages))
    ...
    if (result.functionsContent) {
      let funcName = result.functionsContent.name
      let funcarguments = JSON.parse(result.functionsContent.arguments)
